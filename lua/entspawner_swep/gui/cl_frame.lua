...
function PANEL:Init()
    ...
    self.header.Paint = function(pnl,w,h)
        draw.RoundedBoxEx(10, 0, 0, w, h, ESS.CONFIG.Theme.primary, true, true, false, false )
    end
    ...
    self.header.title:SetTextColor(ESS.CONFIG.Theme.entTextHead)
...
function PANEL:Paint(w, h)
    draw.RoundedBox(10,0,0,w,h,ESS.CONFIG.Theme.background,true,true,true,true)
end
